...
# for(h in 1:1){
   ...
   result.folder.path <- "G:\\Projects\\Prof. Subhajit Dutta (Summer, 2022)\\Results\\Microarray-ALL-Results-newest\\"
   ...
   write_xlsx(x = res.list,
              path = paste0(result.folder.path,files.MA[h],"-our.xlsx"))
   ...
   T.mat.filename <- paste0(T.mat.folder.path,files.MA[h],"-T-matrix.xlsx")
