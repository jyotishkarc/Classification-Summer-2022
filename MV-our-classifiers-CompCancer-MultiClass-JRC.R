...
path <- "E:/JRC-2022/Classification-Summer-2022-JRC/Datasets/CompCancer Database/"
...
for(h in 16:length(files.CC)){
   ...
   result.folder.path <- "E:\\JRC-2022\\Classification-Summer-2022-JRC\\Results\\Real\\CompCancer\\CompCancer-ALL-Results-MV\\"
